    ...
    <>
      ...
      <main className="detail-main">
        ...
        <div className="detail-content container">
          ...
          <div className="episode-selector" id="episode-selector" style={{ display: 'none' }}>
            <div className="season-selector-row">
              <h2 className="section-title" style={{ margin: 0 }}>
                Episodes
              </h2>
              <select id="season-select" className="season-dropdown"></select>
            </div>
            <div className="episodes-grid" id="episodes-grid"></div>
          </div>
